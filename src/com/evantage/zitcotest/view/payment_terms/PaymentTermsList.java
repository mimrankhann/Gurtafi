...
public class PaymentTermsList extends VerticalLayout implements View {

	 	private VaadinSession session=UI.getCurrent().getSession();
	    public static final String VIEW="paymentTermsList";
		public PaymentTermsList paymentTermsList; 
	    ...
	    public PaymentTermsList getSupplierListObject(){
	    ...
	    private Component buildToolbar() {
	        ...
	        Label title = new Label("Payment Terms List");
...
//	        tools.addComponent(createReport);
	        Button addRecord=new Button("Add Record",new ClickListener() {
                ...
                public void buttonClick(final ClickEvent event) {
                	...
                	UI.getCurrent().getNavigator().navigateTo(DashboardViewType.PAYMENTTERMSVIEW.getViewName());
                }
            });
...
//	        Responsive.makeResponsive(header);
//
//	        Label title = new Label("PurchaseOrderPaymentTerms List");
//	        title.setSizeUndefined();
//	        title.addStyleName(ValoTheme.LABEL_H1);
//	        title.addStyleName(ValoTheme.LABEL_NO_MARGIN);
//	        header.addComponent(title);
...
//	                createNewReportFromSelection();
	            ...
	            public void textChange(final TextChangeEvent event) {
	                ...
	                data.addContainerFilter(new Filter() {
	                    ...
	                    public boolean passesFilter(final Object itemId,
	                        ...
	                        return filterByProperty("po_payment_terms_id", item,
	                                event.getText())
	                                || filterByProperty("po_payment_terms", item,
	                                        event.getText());
	                    ...
	                    public boolean appliesToProperty(final Object propertyId) {
	                        if (propertyId.equals("po_payment_terms_id")
	                                || propertyId.equals("po_payment_terms")) {
	                            return true;
	                        }
	                        return false;
	                    }
	    ...
	    private Table buildTable() {
		    ...
		    while(iterator.hasNext()){
		    	...
		    	container.addBean(tempPurchaseOrderPaymentTerms);
		    }
...
//	        table.setColumnAlignment("Price", Align.RIGHT);
	        ...
	        table.setVisibleColumns("po_payment_terms_id", "po_payment_terms");
	        table.setColumnHeaders("Payment Terms ID","Payment Term");
...
//						if (event.isDoubleClick()){
							BeanItem<PurchaseOrderPaymentTerms> item= (BeanItem<PurchaseOrderPaymentTerms>)event.getItem();
							UI.getCurrent().getSession().setAttribute("paymentTermsID", item.getBean().getPo_payment_terms_id());
							UI.getCurrent().getNavigator().navigateTo(DashboardViewType.PAYMENTTERMSVIEW.getViewName()); //+"/"+item.getBean().getPurchaseOrderPaymentTermsId());
//						}
					}
...
//	    }
	    ...
	    public int getTempPurchaseOrderPaymentTermsID(String s){
	    	return customerID;
	    }
