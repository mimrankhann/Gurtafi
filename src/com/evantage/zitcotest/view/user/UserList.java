...
import com.vaadin.ui.themes.ValoTheme;
	...
	public class UserList extends VerticalLayout implements View,Component {
            //zz
		    private VaadinSession session=UI.getCurrent().getSession();
		    public static final String VIEW="userlist";
			// public static final SupplierView supplierView=new SupplierView();
			public UserList supplierlist; 
		    private Table table;
		    ...
		    public UserList getSupplierListObject(){
		    	return supplierlist;
		    }
...
//		        tools.addComponent(createReport);
		        Button addRecord=new Button("Add Record",new ClickListener() {
                    ...
                    public void buttonClick(final ClickEvent event) {
                    	...
                    	UI.getCurrent().getNavigator().navigateTo(DashboardViewType.USERVIEW.getViewName());
...
//		                createNewReportFromSelection();
		            ...
		            public void textChange(final TextChangeEvent event) {
		                ...
		                data.addContainerFilter(new Filter() {
		                    ...
		                    public boolean passesFilter(final Object itemId,
		                        ...
		                        return filterByProperty("id", item,
		                                event.getText())
		                                || filterByProperty("name", item,
		                                        event.getText())
		                                || filterByProperty("role", item,
		                                        event.getText())
		                                || filterByProperty("user_name", item,
		                                        event.getText());
		                    ...
		                    public boolean appliesToProperty(final Object propertyId) {
		                        if (propertyId.equals("id")
		                                ...
		                                || propertyId.equals("role")
		                                || propertyId.equals("user_name")) {
		                            return true;
		                        }
		                        return false;
		                    }
			...
			private Table buildTable() {
		        ...
		        table.setVisibleColumns("id", "name", "role","user_name");
		        table.setColumnHeaders("User ID","Name","Role","User Name");
		        ...
		        table.addListener(new ItemClickListener() {
					...
					public void itemClick(ItemClickEvent event) {
						...
						if (event.isDoubleClick()){
							...
							UI.getCurrent().getSession().setAttribute("userID", item.getBean().getId());
							UI.getCurrent().getNavigator().navigateTo(DashboardViewType.USERVIEW.getViewName()); // +"/"+item.getBean().getId());
						}
