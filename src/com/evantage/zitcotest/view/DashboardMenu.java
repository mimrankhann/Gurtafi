...
import com.evantage.zitcotest.component.ProfilePreferencesWindow;
...
import com.evantage.zitcotest.event.DashboardEvent.PostViewChangeEvent;
import com.evantage.zitcotest.event.DashboardEvent.ProfileUpdatedEvent;
import com.evantage.zitcotest.event.DashboardEvent.ReportsCountUpdatedEvent;
import com.evantage.zitcotest.event.DashboardEvent.TransactionReportEvent;
import com.evantage.zitcotest.event.DashboardEvent.UserLoggedOutEvent;
...
public final class DashboardMenu extends CustomComponent {
    ...
    private static DashboardMenu dashboardMenu;
    ...
    public static DashboardMenu getDashboardMenuObject(){
    ...
    private Component buildTitle() {
        Label logo = new Label("Zitco <strong>Dashboard</strong>",
                ContentMode.HTML);
    ...
    private Component buildUserMenu() {
    	...
    	settingsItem.addItem("Sign Out", new Command() {
    		@Override
    		public void menuSelected(final MenuItem selectedItem) {
    			ZitcotestUI zitcoTestUIObject = new ZitcotestUI();
    			VaadinSession.getCurrent().setAttribute(User.class.getName(),null);
    			ZitcotestUI.getCurrent().close();
    			zitcoTestUIObject.logOut();
    			ZitcotestUI.getCurrent().getPage().setLocation("http://localhost:8090/zitcoTest/");
...
//            }
            ...
            if (view == DashboardViewType.SUPPLIERLIST) {
                notificationsBadge = new Label();
                notificationsBadge.setId(STYLE_VISIBLE);
                menuItemComponent = buildBadgeWrapper(menuItemComponent,
                        notificationsBadge);
            }
            
            if (view == DashboardViewType.CUSTOMERLIST) {
                notificationsBadge = new Label();
                notificationsBadge.setId(STYLE_VISIBLE);
                menuItemComponent = buildBadgeWrapper(menuItemComponent,
                        notificationsBadge);
...
////        int unreadNotificationsCount = ZitcotestUI.getDataProvider()
...
//    }
    ...
    public void updateUserName(final ProfileUpdatedEvent event) {
        ...
        settingsItem.setText(user.getName() + " " + user.getRole());
    }
