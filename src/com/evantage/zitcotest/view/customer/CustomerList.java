...
public class CustomerList extends VerticalLayout implements View {

	 	private VaadinSession session=UI.getCurrent().getSession();
	    public static final String VIEW="customerlist";
	    ...
	    public CustomerList getSupplierListObject(){
	    	return customerList;
	    }
...
//	        tools.addComponent(createReport);
	        Button addRecord=new Button("Add Record",new ClickListener() {
                ...
                public void buttonClick(final ClickEvent event) {
                	...
                	UI.getCurrent().getNavigator().navigateTo(DashboardViewType.CUSTOMERVIEW.getViewName());
                }
            });
...
//	                createNewReportFromSelection();
	            ...
	            public void textChange(final TextChangeEvent event) {
	                ...
	                data.addContainerFilter(new Filter() {
	                    ...
	                    public boolean passesFilter(final Object itemId,
	                        ...
	                        return filterByProperty("customerId", item,
	                                event.getText())
	                                || filterByProperty("customerName", item,
	                                        event.getText())
	                                || filterByProperty("customerShortName", item,
	                                        event.getText())        
	                                || filterByProperty("customerAddress", item,
	                                        event.getText())
	                                || filterByProperty("customerEmail", item,
	                                        event.getText())	                                        
	                                || filterByProperty("customerNTN", item,
	                                        event.getText());
	                    ...
	                    public boolean appliesToProperty(final Object propertyId) {
	                        if (propertyId.equals("customerId")
	                                || propertyId.equals("customerName")
	                                || propertyId.equals("customerShortName")
	                                || propertyId.equals("customerAddress")
	                                || propertyId.equals("customerEmail")
	                                || propertyId.equals("customerEmail")
	                                || propertyId.equals("customerNTN")) {
	                            return true;
	                        }
	                        return false;
	                    }
	    ...
	    private Table buildTable() {
		    ...
		    while(iterator.hasNext()){
		    	...
		    	container.addBean(tempCustomer);
		    }
	        ...
	        table.setVisibleColumns("customerName", "customerShortName", "customerAddress","customerEmail","customerNTN");
	        table.setColumnHeaders("Name","Customer Short Name","Address","Email","NTN");
...
//						if (event.isDoubleClick()){
							...
							UI.getCurrent().getSession().setAttribute("customerID", item.getBean().getCustomerId());
							UI.getCurrent().getNavigator().navigateTo(DashboardViewType.CUSTOMERVIEW.getViewName()); //+"/"+item.getBean().getCustomerId());
//						}
					}
...
//	    }
	    ...
	    public int getTempCustomerID(String s){
	    	return customerID;
	    }
