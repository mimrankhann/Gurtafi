package com.evantage.zitcotest.navigator;
...
public class SupplierViewNavigator extends Navigator{
	    ...
	    public SupplierViewNavigator(final ComponentContainer container) {
	    ...
	    private void initViewChangeListener() {
	        addViewChangeListener(new ViewChangeListener() {
	            ...
	            public void afterViewChange(final ViewChangeEvent event) {
	                ...
	                //zz un-comment
	                System.out.println("View change event fire getViewName=" + event.getViewName());
	                System.out.println("View change event fire getParameter=" + event.getParameters()); 
